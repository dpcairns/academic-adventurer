...
test('renderAdventure', (expect) => {
    ...
    const expected = `<section><label><a href="../academic-adventurer/3-game-page/?id=adventure1"><img src="../assets/blue.png"></a><input type="radio" value="adventure1" name="adventure-choice" class="pack-div"></label></section>`;
